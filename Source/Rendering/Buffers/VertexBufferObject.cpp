...
namespace Ludvig
{
    namespace Rendering
    {
        VertexBufferObject::VertexBufferObject(int dim,int index, const std::vector<glm::vec2> &data, int GL_BUFFER)
        {
        ...
        VertexBufferObject::VertexBufferObject(int dim,int index, const std::vector<glm::vec3> &data, int GL_BUFFER)
        {
            glGenBuffers(1,&this->buffer);
            glBindBuffer(GL_BUFFER,this->buffer);
        ...
        VertexBufferObject::VertexBufferObject(int dim,int index, const std::vector<unsigned int> &data, int GL_BUFFER)
        {
            glGenBuffers(1,&this->buffer);
            glBindBuffer(GL_BUFFER,this->buffer);
