...
namespace Ludvig
{
    namespace Rendering
    {
        Renderer::Renderer(Window* window)
        {
            ...
            this->shaders.push_back(std::make_unique<Rendering::Shader>("assets/shaders/default_vertex.glsl","assets/shaders/default_fragment.glsl"));
            this->shaders.push_back(std::make_unique<Rendering::Shader>("assets/shaders/skybox_vertex.glsl","assets/shaders/skybox_fragment.glsl"));
            this->shaders.push_back(std::make_unique<Rendering::Shader>("assets/shaders/framebuffer_vertex.glsl","assets/shaders/framebuffer_fragment.glsl"));

            this->textures.push_back(std::make_unique<Rendering::Texture>("assets/textures/grey.jpg"));
        ...
        void Renderer::create_gui_frame()
        {
